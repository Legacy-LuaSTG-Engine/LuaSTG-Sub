...
void imgui::binding::registerConstants(lua_State* const vm) {
	...
	}
	{
		...
		ctx.set_map_value(e, "SelectOnNav"sv, ImGuiSelectableFlags_SelectOnNav);
	}
	{
		auto const e = ctx.create_map(10);
	...
	}
	{
		...
		ctx.set_map_value(e, "None"sv, ImGuiDir_None);
		ctx.set_map_value(e, "Left"sv, ImGuiDir_Left);
		ctx.set_map_value(e, "Right"sv, ImGuiDir_Right);
		ctx.set_map_value(e, "Up"sv, ImGuiDir_Up);
		ctx.set_map_value(e, "Down"sv, ImGuiDir_Down);
		ctx.set_map_value(e, "COUNT"sv, ImGuiDir_COUNT);
	}
	{
		auto const e = ctx.create_map(3);
		ctx.set_map_value(m, "ImGuiSortDirection"sv, e);
		ctx.set_map_value(e, "None"sv, ImGuiSortDirection_None);
		ctx.set_map_value(e, "Ascending"sv, ImGuiSortDirection_Ascending);
	...
	}
	{
		...
		ctx.set_map_value(e, "Tab"sv, ImGuiKey_Tab);
		ctx.set_map_value(e, "LeftArrow"sv, ImGuiKey_LeftArrow);
		ctx.set_map_value(e, "RightArrow"sv, ImGuiKey_RightArrow);
		ctx.set_map_value(e, "UpArrow"sv, ImGuiKey_UpArrow);
		ctx.set_map_value(e, "DownArrow"sv, ImGuiKey_DownArrow);
		ctx.set_map_value(e, "PageUp"sv, ImGuiKey_PageUp);
		ctx.set_map_value(e, "PageDown"sv, ImGuiKey_PageDown);
		ctx.set_map_value(e, "Home"sv, ImGuiKey_Home);
		ctx.set_map_value(e, "End"sv, ImGuiKey_End);
		ctx.set_map_value(e, "Insert"sv, ImGuiKey_Insert);
		ctx.set_map_value(e, "Delete"sv, ImGuiKey_Delete);
		ctx.set_map_value(e, "Backspace"sv, ImGuiKey_Backspace);
		ctx.set_map_value(e, "Space"sv, ImGuiKey_Space);
		ctx.set_map_value(e, "Enter"sv, ImGuiKey_Enter);
		ctx.set_map_value(e, "Escape"sv, ImGuiKey_Escape);
		ctx.set_map_value(e, "LeftCtrl"sv, ImGuiKey_LeftCtrl);
		ctx.set_map_value(e, "LeftShift"sv, ImGuiKey_LeftShift);
		ctx.set_map_value(e, "LeftAlt"sv, ImGuiKey_LeftAlt);
		ctx.set_map_value(e, "LeftSuper"sv, ImGuiKey_LeftSuper);
		ctx.set_map_value(e, "RightCtrl"sv, ImGuiKey_RightCtrl);
		ctx.set_map_value(e, "RightShift"sv, ImGuiKey_RightShift);
		ctx.set_map_value(e, "RightAlt"sv, ImGuiKey_RightAlt);
		ctx.set_map_value(e, "RightSuper"sv, ImGuiKey_RightSuper);
		ctx.set_map_value(e, "Menu"sv, ImGuiKey_Menu);
		ctx.set_map_value(e, "0"sv, ImGuiKey_0);
		ctx.set_map_value(e, "1"sv, ImGuiKey_1);
		ctx.set_map_value(e, "2"sv, ImGuiKey_2);
		ctx.set_map_value(e, "3"sv, ImGuiKey_3);
		ctx.set_map_value(e, "4"sv, ImGuiKey_4);
		ctx.set_map_value(e, "5"sv, ImGuiKey_5);
		ctx.set_map_value(e, "6"sv, ImGuiKey_6);
		ctx.set_map_value(e, "7"sv, ImGuiKey_7);
		ctx.set_map_value(e, "8"sv, ImGuiKey_8);
		ctx.set_map_value(e, "9"sv, ImGuiKey_9);
		ctx.set_map_value(e, "A"sv, ImGuiKey_A);
		ctx.set_map_value(e, "B"sv, ImGuiKey_B);
		ctx.set_map_value(e, "C"sv, ImGuiKey_C);
		ctx.set_map_value(e, "D"sv, ImGuiKey_D);
		ctx.set_map_value(e, "E"sv, ImGuiKey_E);
		ctx.set_map_value(e, "F"sv, ImGuiKey_F);
		ctx.set_map_value(e, "G"sv, ImGuiKey_G);
		ctx.set_map_value(e, "H"sv, ImGuiKey_H);
		ctx.set_map_value(e, "I"sv, ImGuiKey_I);
		ctx.set_map_value(e, "J"sv, ImGuiKey_J);
		ctx.set_map_value(e, "K"sv, ImGuiKey_K);
		ctx.set_map_value(e, "L"sv, ImGuiKey_L);
		ctx.set_map_value(e, "M"sv, ImGuiKey_M);
		ctx.set_map_value(e, "N"sv, ImGuiKey_N);
		ctx.set_map_value(e, "O"sv, ImGuiKey_O);
		ctx.set_map_value(e, "P"sv, ImGuiKey_P);
		ctx.set_map_value(e, "Q"sv, ImGuiKey_Q);
		ctx.set_map_value(e, "R"sv, ImGuiKey_R);
		ctx.set_map_value(e, "S"sv, ImGuiKey_S);
		ctx.set_map_value(e, "T"sv, ImGuiKey_T);
		ctx.set_map_value(e, "U"sv, ImGuiKey_U);
		ctx.set_map_value(e, "V"sv, ImGuiKey_V);
		ctx.set_map_value(e, "W"sv, ImGuiKey_W);
		ctx.set_map_value(e, "X"sv, ImGuiKey_X);
		ctx.set_map_value(e, "Y"sv, ImGuiKey_Y);
		ctx.set_map_value(e, "Z"sv, ImGuiKey_Z);
		ctx.set_map_value(e, "F1"sv, ImGuiKey_F1);
		ctx.set_map_value(e, "F2"sv, ImGuiKey_F2);
		ctx.set_map_value(e, "F3"sv, ImGuiKey_F3);
		ctx.set_map_value(e, "F4"sv, ImGuiKey_F4);
		ctx.set_map_value(e, "F5"sv, ImGuiKey_F5);
		ctx.set_map_value(e, "F6"sv, ImGuiKey_F6);
		ctx.set_map_value(e, "F7"sv, ImGuiKey_F7);
		ctx.set_map_value(e, "F8"sv, ImGuiKey_F8);
		ctx.set_map_value(e, "F9"sv, ImGuiKey_F9);
		ctx.set_map_value(e, "F10"sv, ImGuiKey_F10);
		ctx.set_map_value(e, "F11"sv, ImGuiKey_F11);
		ctx.set_map_value(e, "F12"sv, ImGuiKey_F12);
		ctx.set_map_value(e, "F13"sv, ImGuiKey_F13);
		ctx.set_map_value(e, "F14"sv, ImGuiKey_F14);
		ctx.set_map_value(e, "F15"sv, ImGuiKey_F15);
		ctx.set_map_value(e, "F16"sv, ImGuiKey_F16);
		ctx.set_map_value(e, "F17"sv, ImGuiKey_F17);
		ctx.set_map_value(e, "F18"sv, ImGuiKey_F18);
		ctx.set_map_value(e, "F19"sv, ImGuiKey_F19);
		ctx.set_map_value(e, "F20"sv, ImGuiKey_F20);
		ctx.set_map_value(e, "F21"sv, ImGuiKey_F21);
		ctx.set_map_value(e, "F22"sv, ImGuiKey_F22);
		ctx.set_map_value(e, "F23"sv, ImGuiKey_F23);
		ctx.set_map_value(e, "F24"sv, ImGuiKey_F24);
		ctx.set_map_value(e, "Apostrophe"sv, ImGuiKey_Apostrophe);
		ctx.set_map_value(e, "Comma"sv, ImGuiKey_Comma);
		ctx.set_map_value(e, "Minus"sv, ImGuiKey_Minus);
		ctx.set_map_value(e, "Period"sv, ImGuiKey_Period);
		ctx.set_map_value(e, "Slash"sv, ImGuiKey_Slash);
		ctx.set_map_value(e, "Semicolon"sv, ImGuiKey_Semicolon);
		ctx.set_map_value(e, "Equal"sv, ImGuiKey_Equal);
		ctx.set_map_value(e, "LeftBracket"sv, ImGuiKey_LeftBracket);
		ctx.set_map_value(e, "Backslash"sv, ImGuiKey_Backslash);
		ctx.set_map_value(e, "RightBracket"sv, ImGuiKey_RightBracket);
		ctx.set_map_value(e, "GraveAccent"sv, ImGuiKey_GraveAccent);
		ctx.set_map_value(e, "CapsLock"sv, ImGuiKey_CapsLock);
		ctx.set_map_value(e, "ScrollLock"sv, ImGuiKey_ScrollLock);
		ctx.set_map_value(e, "NumLock"sv, ImGuiKey_NumLock);
		ctx.set_map_value(e, "PrintScreen"sv, ImGuiKey_PrintScreen);
		ctx.set_map_value(e, "Pause"sv, ImGuiKey_Pause);
		ctx.set_map_value(e, "Keypad0"sv, ImGuiKey_Keypad0);
		ctx.set_map_value(e, "Keypad1"sv, ImGuiKey_Keypad1);
		ctx.set_map_value(e, "Keypad2"sv, ImGuiKey_Keypad2);
		ctx.set_map_value(e, "Keypad3"sv, ImGuiKey_Keypad3);
		ctx.set_map_value(e, "Keypad4"sv, ImGuiKey_Keypad4);
		ctx.set_map_value(e, "Keypad5"sv, ImGuiKey_Keypad5);
		ctx.set_map_value(e, "Keypad6"sv, ImGuiKey_Keypad6);
		ctx.set_map_value(e, "Keypad7"sv, ImGuiKey_Keypad7);
		ctx.set_map_value(e, "Keypad8"sv, ImGuiKey_Keypad8);
		ctx.set_map_value(e, "Keypad9"sv, ImGuiKey_Keypad9);
		ctx.set_map_value(e, "KeypadDecimal"sv, ImGuiKey_KeypadDecimal);
		ctx.set_map_value(e, "KeypadDivide"sv, ImGuiKey_KeypadDivide);
		ctx.set_map_value(e, "KeypadMultiply"sv, ImGuiKey_KeypadMultiply);
		ctx.set_map_value(e, "KeypadSubtract"sv, ImGuiKey_KeypadSubtract);
		ctx.set_map_value(e, "KeypadAdd"sv, ImGuiKey_KeypadAdd);
		ctx.set_map_value(e, "KeypadEnter"sv, ImGuiKey_KeypadEnter);
		ctx.set_map_value(e, "KeypadEqual"sv, ImGuiKey_KeypadEqual);
		ctx.set_map_value(e, "AppBack"sv, ImGuiKey_AppBack);
		ctx.set_map_value(e, "AppForward"sv, ImGuiKey_AppForward);
		ctx.set_map_value(e, "Oem102"sv, ImGuiKey_Oem102);
		ctx.set_map_value(e, "GamepadStart"sv, ImGuiKey_GamepadStart);
		ctx.set_map_value(e, "GamepadBack"sv, ImGuiKey_GamepadBack);
		ctx.set_map_value(e, "GamepadFaceLeft"sv, ImGuiKey_GamepadFaceLeft);
		ctx.set_map_value(e, "GamepadFaceRight"sv, ImGuiKey_GamepadFaceRight);
		ctx.set_map_value(e, "GamepadFaceUp"sv, ImGuiKey_GamepadFaceUp);
		ctx.set_map_value(e, "GamepadFaceDown"sv, ImGuiKey_GamepadFaceDown);
		ctx.set_map_value(e, "GamepadDpadLeft"sv, ImGuiKey_GamepadDpadLeft);
		ctx.set_map_value(e, "GamepadDpadRight"sv, ImGuiKey_GamepadDpadRight);
		ctx.set_map_value(e, "GamepadDpadUp"sv, ImGuiKey_GamepadDpadUp);
		ctx.set_map_value(e, "GamepadDpadDown"sv, ImGuiKey_GamepadDpadDown);
		ctx.set_map_value(e, "GamepadL1"sv, ImGuiKey_GamepadL1);
		ctx.set_map_value(e, "GamepadR1"sv, ImGuiKey_GamepadR1);
		ctx.set_map_value(e, "GamepadL2"sv, ImGuiKey_GamepadL2);
		ctx.set_map_value(e, "GamepadR2"sv, ImGuiKey_GamepadR2);
		ctx.set_map_value(e, "GamepadL3"sv, ImGuiKey_GamepadL3);
		ctx.set_map_value(e, "GamepadR3"sv, ImGuiKey_GamepadR3);
		ctx.set_map_value(e, "GamepadLStickLeft"sv, ImGuiKey_GamepadLStickLeft);
		ctx.set_map_value(e, "GamepadLStickRight"sv, ImGuiKey_GamepadLStickRight);
		ctx.set_map_value(e, "GamepadLStickUp"sv, ImGuiKey_GamepadLStickUp);
		ctx.set_map_value(e, "GamepadLStickDown"sv, ImGuiKey_GamepadLStickDown);
		ctx.set_map_value(e, "GamepadRStickLeft"sv, ImGuiKey_GamepadRStickLeft);
		ctx.set_map_value(e, "GamepadRStickRight"sv, ImGuiKey_GamepadRStickRight);
		ctx.set_map_value(e, "GamepadRStickUp"sv, ImGuiKey_GamepadRStickUp);
		ctx.set_map_value(e, "GamepadRStickDown"sv, ImGuiKey_GamepadRStickDown);
		ctx.set_map_value(e, "MouseLeft"sv, ImGuiKey_MouseLeft);
		ctx.set_map_value(e, "MouseRight"sv, ImGuiKey_MouseRight);
		ctx.set_map_value(e, "MouseMiddle"sv, ImGuiKey_MouseMiddle);
		ctx.set_map_value(e, "MouseX1"sv, ImGuiKey_MouseX1);
		ctx.set_map_value(e, "MouseX2"sv, ImGuiKey_MouseX2);
		ctx.set_map_value(e, "MouseWheelX"sv, ImGuiKey_MouseWheelX);
		ctx.set_map_value(e, "MouseWheelY"sv, ImGuiKey_MouseWheelY);
		ctx.set_map_value(e, "ReservedForModCtrl"sv, ImGuiKey_ReservedForModCtrl);
		ctx.set_map_value(e, "ReservedForModShift"sv, ImGuiKey_ReservedForModShift);
		ctx.set_map_value(e, "ReservedForModAlt"sv, ImGuiKey_ReservedForModAlt);
		ctx.set_map_value(e, "ReservedForModSuper"sv, ImGuiKey_ReservedForModSuper);
		ctx.set_map_value(e, "NamedKey_END"sv, ImGuiKey_NamedKey_END);
		ctx.set_map_value(e, "NamedKey_COUNT"sv, ImGuiKey_NamedKey_COUNT);
	...
	}
	{
		...
		ctx.set_map_value(e, "Mouse"sv, ImGuiMouseSource_Mouse);
		ctx.set_map_value(e, "TouchScreen"sv, ImGuiMouseSource_TouchScreen);
		ctx.set_map_value(e, "Pen"sv, ImGuiMouseSource_Pen);
		ctx.set_map_value(e, "COUNT"sv, ImGuiMouseSource_COUNT);
	}
	{
	...
	{
		auto const e = ctx.create_map(2);
		ctx.set_map_value(m, "ImGuiListClipperFlags"sv, e);
		ctx.set_map_value(e, "None"sv, ImGuiListClipperFlags_None);
	...
	}
	{
		...
		ctx.set_map_value(e, "None"sv, ImGuiSelectionRequestType_None);
		ctx.set_map_value(e, "SetAll"sv, ImGuiSelectionRequestType_SetAll);
	...
	}
	{
		...
		ctx.set_map_value(e, "RGBA32"sv, ImTextureFormat_RGBA32);
		ctx.set_map_value(e, "Alpha8"sv, ImTextureFormat_Alpha8);
	}
	{
		auto const e = ctx.create_map(5);
		ctx.set_map_value(m, "ImTextureStatus"sv, e);
		ctx.set_map_value(e, "OK"sv, ImTextureStatus_OK);
		ctx.set_map_value(e, "Destroyed"sv, ImTextureStatus_Destroyed);
		ctx.set_map_value(e, "WantCreate"sv, ImTextureStatus_WantCreate);
		ctx.set_map_value(e, "WantUpdates"sv, ImTextureStatus_WantUpdates);
		ctx.set_map_value(e, "WantDestroy"sv, ImTextureStatus_WantDestroy);
	}
	{
		auto const e = ctx.create_map(4);
