...
ImGuiTextBufferMember mapImGuiTextBufferMember(char const* const key, size_t const len) noexcept {
    ...
    for (size_t i = 0; i < len; i += 1) {
        ...
        case 0:
            ...
            case make_condition(0, 'r'): state = 21; continue; // -> reserve, resize
            case make_condition(0, 's'): state = 31; continue; // -> size
        ...
        case 1:
            ...
            case make_condition(21, 'e'): state = 22; continue; // -> reserve, resize
            case make_condition(31, 'i'): state = 32; continue; // -> size
            default: return ImGuiTextBufferMember::__unknown__;
            }
        case 2:
            switch (make_condition(state, key[i])) {
            ...
            case make_condition(22, 's'): state = 23; continue; // -> reserve, resize
            case make_condition(32, 'z'): state = 33; continue; // -> size
            default: return ImGuiTextBufferMember::__unknown__;
            }
        case 3:
            switch (make_condition(state, key[i])) {
            ...
            case make_condition(23, 'i'): state = 28; continue; // -> resize
            case make_condition(33, 'e'): state = 34; continue; // -> size
            default: return ImGuiTextBufferMember::__unknown__;
            }
        case 4:
            switch (make_condition(state, key[i])) {
            ...
            case make_condition(28, 'z'): state = 29; continue; // -> resize
            default: return ImGuiTextBufferMember::__unknown__;
            }
        case 5:
            switch (make_condition(state, key[i])) {
            ...
            case make_condition(29, 'e'): state = 30; continue; // -> resize
            default: return ImGuiTextBufferMember::__unknown__;
            }
        case 6:
            switch (make_condition(state, key[i])) {
    ...
    case 30: return ImGuiTextBufferMember::resize;
    case 34: return ImGuiTextBufferMember::size;
    default: return ImGuiTextBufferMember::__unknown__;
    }
}
