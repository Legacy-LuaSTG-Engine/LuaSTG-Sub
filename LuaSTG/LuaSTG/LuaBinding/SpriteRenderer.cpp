...
namespace LuaSTG::Sub::LuaBinding {
	...
	void SpriteRenderer::registerClass(lua_State* vm) {
		...
		ctx.set_map_value(method_table, "setRect", &SpriteRendererBinding::setRect);
		ctx.set_map_value(method_table, "setQuad", &SpriteRendererBinding::setQuad);
