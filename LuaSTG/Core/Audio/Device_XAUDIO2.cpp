...
namespace LuaSTG::Core::Audio
{
	...
	void Device_XAUDIO2::setMixChannelVolume(MixChannel ch, float v)
	{
		...
		switch (ch)
		{
		case LuaSTG::Core::Audio::MixChannel::Direct: p_voice = m_shared->xa2_master; break;
		case LuaSTG::Core::Audio::MixChannel::SoundEffect: p_voice = m_shared->xa2_soundeffect; break;
		case LuaSTG::Core::Audio::MixChannel::Music: p_voice = m_shared->xa2_music; break;
		default: break;
		}
		assert(p_voice);
		if (p_voice)
